...
import com.shorman.movies.adapters.MovieImageAdapter
import com.shorman.movies.moviesApi.models.movie.MovieDetails
...
class MovieDetailsTwoFragment(private val movieId: Int):Fragment(R.layout.movie_details_two) {
    ...
    private fun setUpObservers(){
        ...
        mainViewModel.movieComments.observe(viewLifecycleOwner){
